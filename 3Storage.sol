...
contract EmployeeStorage {
    ...
    constructor() {
        shares = 1000; // Initialize shares to 1000
        salary = 50000; // Initialize salary to 50000
        idNumber = 112358132134; // Initialize idNumber to 112358132134
        name = "Pat"; // Initialize name to "Pat"
    }
